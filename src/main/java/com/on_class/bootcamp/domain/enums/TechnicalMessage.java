package com.on_class.bootcamp.domain.enums;
...
public enum TechnicalMessage {
    ...
    PAGINATION_BAD_REQUEST(DomainConstants.STATUS_CODE_BAD_REQUEST, DomainConstants.MESSAGE_PAGINATION_BAD_REQUEST);
